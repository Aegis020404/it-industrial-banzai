...
const initialState = [{
    ...
    imageInfo: [['', '/1stroimat.WebP'], ['Главная страница', '/2stroimat.WebP'], ['Мобильная версия', '/3stroimat.WebP'], ['Карточка товара и каталог', '/4stroimat.WebP'], ['Элементы интерфейса', '/5stroimat.WebP'], ['Спасибо за просмотр!', '/6stroimat.WebP']]
    ...
    imageInfo: [['', '/1estetic.WebP'], ['Каталог товаров', '/2estetic.WebP'], ['Карточка товара', '/3estetic.WebP'], ['Оформление заказа и оплата', '/4estetic.WebP'], ['Мобильная версия', '/5estetic.WebP'], ['Спасибо за просмотр!', '/6estetic.WebP']]
    ...
    imageInfo: [['', '/1hockey.WebP'], ['Главный экран', '/2hockey.WebP'], ['О клубе', '/3hockey.WebP'], ['Цены и как записаться', '/4hockey.WebP'], ['Мобильная версия', '/5hockey.WebP'], ['Спасибо за просмотр!', '/6hockey.WebP']]
    ...
    imageInfo: [['', '/1lumar.WebP'], ['Главная страница', '/2lumar.WebP'], ['Каталог пленок', '/3lumar.WebP'], ['Мобильная версия', '/4lumar.WebP'], ['Элементы интерфейса', '/5lumar.WebP'], ['Спасибо за просмотр!', '/6lumar.WebP']]
    ...
    imageInfo: [['', '/1acovtor.png'], ['Главная страница', '/2acovtor.WebP'], ['Мобильная версия', '/3acovtor.WebP'], ['Заказ услуги', '/4acovtor.WebP'], ['Мобильная версия', '/5acovtor.WebP'], ['Спасибо за просмотр!', '/6acovtor.WebP']]
    ...
    imageInfo: [['', '/app1.WebP'], ['Заказ', '/app2.WebP'], ['Автопарк', '/app3.WebP'], ['Аналитика', '/app4.WebP'], ['Элементы', '/app5.WebP'], ['Спасибо за просмотр!', '/app6.WebP']]
    ...
    imageInfo: [['', '/1crm.WebP'], ['Основное', '/2crm.WebP'], ['Мобильная версия', '/3crm.WebP'], ['Продажи по дилерам', '/4crm.WebP'], ['Гарантийные талоны', '/5crm.WebP'], ['Спасибо за просмотр!', '/6crm.WebP']]
