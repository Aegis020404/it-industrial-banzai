        ...
        <section className={cl.stableSection}>
            <div className="container">
                <MyViewElement element={
                    isAdmin ? 
                    <MyAdminInput width={stableData.title.width}  height={stableData.title.height} typeAction={'TITLE_SEO_STABLE_INFO'}>
                ...
                <div className={cl.stableListBlock}>
                    ...
                    <ul className={cl.stableList}>
                        {infoArr.map((e, i)=>
                            <SeoStableItem title={e.title} id={e.id} descr={e.descr} key={i} img={e.img}/>
                        )}
                    </ul>
                </div>
            </div>
