        ...
        <section className={cl.reportSection}>
            <div className="container">
                <MyViewElement element={
                     isAdmin ? 
                     <MyAdminInput width={reportInfo.title.width}  height={reportInfo.title.height} typeAction={'TITLE_SEO_REPORT_INFO'}>
                ...
                <div className={cl.reportListBLock}>
                    <MyAddElement typeAction={'ADD_SEO_REPORT_ELEMENT'}></MyAddElement>
                    <ul className={cl.reportList}>
                        {infoArr.map((e, i)=><SeoReportItem text={e.text} id={e.id} key={i} />)}
                    </ul>
                </div>
                <MyViewElement element={
                     ...
                     {isAdmin ? 
                     <MyAdminInput width={reportInfo.number.width}  height={reportInfo.number.height} typeAction={'NUMBER_SEO_REPORT_INFO'}>
                     ...
                     <span className={cl.reportMCount}>{seoTexts.number}</span>
                       ...
                       {  isAdmin ? 
                     <MyAdminInput width={reportInfo.value.width}  height={reportInfo.value.height} typeAction={'VALUE_SEO_REPORT_INFO'}>
                     ...
                     {  isAdmin ? 
                        <MyAdminInput width={reportInfo.bottomTitle.width}  height={reportInfo.bottomTitle.height} typeAction={'BOTTOM_TITLE_SEO_REPORT_INFO'}>
                       ...
                       {  isAdmin ? 
                        <MyAdminInput width={reportInfo.bottomDescr.width}  height={reportInfo.bottomDescr.height} typeAction={'BOTTOM_DESCR_SEO_REPORT_INFO'}>
