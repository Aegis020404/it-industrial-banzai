        ...
        <section className={cl.textSection}>
            <div className="container">
                <div className={cl.textCont}>
                    {isAdmin ? 
                        <MyAdminInput  width={textInfo.overDescr.width} height={textInfo.overDescr.height} typeAction={'OVER_DESCR_MARKETPLACE_TEXTS_INFO'}>
                    ...
                    {isAdmin ? 
                        <MyAdminInput  width={textInfo.title.width} height={textInfo.title.height} typeAction={'TITLE_MARKETPLACE_TEXTS_INFO'}>
                    ...
                    {isAdmin ? 
                        <MyAdminInput  width={textInfo.descr.width} height={textInfo.descr.height} typeAction={'DESCR_MARKETPLACE_TEXTS_INFO'}>
