    ...
    return (
        <MyViewElement element={
            <li className={cl.seoItem}>
                <MyDeleteElement typeAction={'DELETE_KEYS_SEO_ELEMENT'} id={id}/>
            ...
            <div className={cl.seoItemBlock}>
                <div className={cl.seoLeftBlock}>
                    {
                         isAdmin ? 
                         <MyAdminInput id={id} width={sizeInfo.title.width}  height={sizeInfo.title.height} typeAction={'NAME_KEYS_SEO_CHANGE'}>
                    ...
                    {
                         isAdmin ? 
                         <MyAdminInput id={id} width={sizeInfo.link.width}  height={sizeInfo.link.height} typeAction={'LINK_KEYS_SEO_CHANGE'}>
                        ...
                        <div className={cl.seoChangeTop}>
                            ...
                            <div className={cl.seoChangeCard}>
                                <div className={cl.seoChangeGridBlock}>
                                    {  isAdmin ? 
                                        <MyAdminInput id={id} width={sizeInfo.topTenTitle.width}  height={sizeInfo.topTenTitle.height} typeAction={'TOP_TEN_TITLE_SEO_CHANGE'}>
                                    ...
                                    {  isAdmin ? 
                                        <MyAdminInput id={id} width={sizeInfo.beenTopTen.width}  height={sizeInfo.beenTopTen.height} typeAction={'BEEN_TEN_SEO_CHANGE'}>
                                ...
                                <div className={cl.seoChangeGridBlock}>
                                    {  isAdmin ? 
                                        <MyAdminInput id={id} width={sizeInfo.trafficTitle.width}  height={sizeInfo.trafficTitle.height} typeAction={'TRAFFIC_TITLE_SEO_CHANGE'}>
                                    ...
                                    {  isAdmin ? 
                                        <MyAdminInput id={id} width={sizeInfo.beenTraffic.width}  height={sizeInfo.beenTraffic.height} typeAction={'BEEN_TRAFFIS_SEO_CHANGE'}>
                        ...
                        <div className={cl.seoChangeBottom}>
                            ...
                            <div className={cl.seoChangeCard}>
                                <div className={cl.seoChangeGridBlock}>
                                    ...
                                    {  isAdmin ? 
                                        <MyAdminInput id={id} width={sizeInfo.becameTopTen.width}  height={sizeInfo.becameTopTen.height} typeAction={'BECAME_TEN_SEO_CHANGE'}>
                                ...
                                <div className={cl.seoChangeGridBlock}>
                                    ...
                                    {  isAdmin ? 
                                        <MyAdminInput id={id} width={sizeInfo.becameTraffic.width}  height={sizeInfo.becameTraffic.height} typeAction={'BECAME_TRAFFIS_SEO_CHANGE'}>
                ...
                <div className={cl.seoRightBlock}>
                    {  isAdmin ? 
                        <MyAdminInput id={id} width={sizeInfo.titleTopLeft.width}  height={sizeInfo.titleTopLeft.height} typeAction={'TOP_TITLE_LEFT_SEO_CHANGE'}>
                                        ...
                                        <div className={cl.seoGraphTop}>
                                            <ul className={cl.seoGraphRightL}>
                                                {monthsGrey.map((e, i)=><li key={i} className={cl.seoGraphItem}>
                                                    ...
                                                    {
                                                         isAdmin ? 
                                                         <MyAdminInput id={id} count={e.id} width={sizeInfo.graphName.width}  height={sizeInfo.graphName.height} typeAction={'NAME_INPUTS_SEO_KEYS_CHANGE'}>
